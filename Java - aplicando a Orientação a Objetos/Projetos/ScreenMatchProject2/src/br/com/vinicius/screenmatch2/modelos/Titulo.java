...
public class Titulo {
    ...
    private int anoDeLanamento; // Ano de lançamento do título
    ...
    public void setAnoDeLanamento(int anoDeLanamento) {
        this.anoDeLanamento = anoDeLanamento;
    }
    ...
    public int getAnoDeLanamento() {
        return anoDeLanamento;
    }
